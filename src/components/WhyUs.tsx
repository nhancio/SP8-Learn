      ...
      <div className="bg-white/90 rounded-3xl shadow-2xl p-10 border border-purple-100 flex flex-col md:flex-row items-center gap-8 animate-fade-in">
        <div className="flex flex-col items-center md:items-start gap-4 flex-1">
          ...
          <p className="text-lg text-gray-700 font-inter">
              began as a passion project by a group of IITians who wanted to make AI and development skills accessible to everyone. What started as a single course has now grown into a thriving team, building real-world projects and empowering hundreds of learners to transform their careers. Our mission is to blend hands-on learning, mentorship, and the latest technology to help you succeed in the digital age.
          </p>
        </div>
      </div>
    </div>
